...
if __name__ == '__main__':
	...
	X_train, Y_train = parse_instances_vector_label('test/ds2/ds2Train.csv')
	X_validate, Y_validate = parse_instances_vector_label('test/ds2/ds2Val.csv')
	...
	csv_write('ds2Val-nb.csv', Y_pred)
	print("naive bayes binary values - accuracy : " + str(accuracy_score(Y_validate, Y_pred)))
	joblib.dump(nb_classifier, 'ds2_nb_classifier.joblib')
	...
	csv_write('ds2Val-dt.csv', Y_pred)
	print("decision tree pooling values - accuracy : " + str(accuracy_score(Y_validate, Y_pred)))
	joblib.dump(dtp_classifier, 'ds2_dt_classifier.joblib')
	...
	csv_write('ds2Val-3.csv', Y_pred)
	print("svm pooling values - accuracy : " + str(accuracy_score(Y_validate, Y_pred)))
	joblib.dump(svmclfp, 'ds2_svm_classifier.joblib')
